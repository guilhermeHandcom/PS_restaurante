...
class FuncionariosControllerTest < ActionController::TestCase
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post :create, funcionario: { cargo: @funcionario.cargo, cpf: @funcionario.cpf, data_nascimento: @funcionario.data_nascimento, nome: @funcionario.nome, telefone: @funcionario.telefone }
    end
  ...
  test "should update funcionario" do
    patch :update, id: @funcionario, funcionario: { cargo: @funcionario.cargo, cpf: @funcionario.cpf, data_nascimento: @funcionario.data_nascimento, nome: @funcionario.nome, telefone: @funcionario.telefone }
    assert_redirected_to funcionario_path(assigns(:funcionario))
  end
